...
const Nav = () => {
    return (
        <>
            <motion.div className="fixed right-1/2 h-[3rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.1rem] md:translate-x-[-100px] md:top-12 md:h-[12rem] md:w-[4rem] md:rounded-lg dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
