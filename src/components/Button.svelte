...
<!-- OLD BUTTON THAT WORKS! BUT ONLY WITH CLASSIC CSS DECLARATION INSTEAD OF TAILWINDCSS -->
<!-- <button on:click={toggle} class="flex h-9 w-9 items-center justify-center rounded-lg transition-all bg-orange-500 text-white uppercase px-2 py-1 dark:bg-blue-600">
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
...
<!-- <style>
    ...
    :global(body.dark-mode) button.flex {
        background-color: #0084f6;
        color: white;
    }
</style> -->